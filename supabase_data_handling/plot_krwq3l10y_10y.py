...
def plot_historical_graph(symbol='KRWQ3L10Y'):
    ...
    try:
        ...
        plt.plot(df['date'], df['value'], linestyle='-', color='#d62728', linewidth=1.5) # Red color for 10Y
...
if __name__ == "__main__":
    plot_historical_graph('KRWQ3L10Y')
